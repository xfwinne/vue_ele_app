  ...
  <div class="seller-wrap" ref="sellerWrap">
    <div class="seller-content">
        ...
        <ul v-if="seller.supports" class="mark-supports supports">
            <li class="support-item clearfix border-1px" v-for="(item,index) in seller.supports">
...
.seller-wrap .pics-wrap .pic-item>img{}
...
.seller-wrap .seller-info .ul-list{}
