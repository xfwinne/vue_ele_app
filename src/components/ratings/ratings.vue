<template>
  <div class="ratings-wrap" ref="ratingsWrap">
    <div class="ratings-content" >
        ...
        <v-split></v-split>
        <v-ratingselect v-on:ratingtype-select="ratingtypeSelect" v-on:content-toggle="contentToggle" :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="ratings"></v-ratingselect>
                ...
                <li v-for="rating in ratings" class="rating-item border-1px" v-show="needShow(rating.rateType,rating.text)">
                    ...
                    <div class="content">
                        ...
                        <div class="recommend" v-show="rating.recommend.length">
                            <span class="icon-thumb_up" ></span><span class="text" v-for="rec in rating.recommend">{{rec}}</span>
                        </div>
                        <div class="time">
...
.ratings-wrap .over-view .right .delivery-time{}
